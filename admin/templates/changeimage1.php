...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if(isset($_POST['update']))
    {
        ...
        $sql="update cars set CarImage1=:vimage1 where id=:id";
                ...
                <div class="col-md-12">
                    <form method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            $id=intval($_GET['imgid']);
                            $sql ="SELECT CarImage1 from cars where cars.id=:id";
                            $query = $dbh -> prepare($sql);
                            $query-> bindParam(':id', $id, PDO::PARAM_STR);
                            $query->execute();
                            ...
                            if($query->rowCount() > 0)
                            {
                                foreach($results as $result) {	?>
                                    <div class="col-sm-8">
                                        <img src="../img/carimages/<?php echo htmlentities($result->CarImage1);?>" width="300" height="200" style="border:solid 1px #000">
                                    </div>
                                <?php }}?>
                        </div>
                        <div class="form-group">
