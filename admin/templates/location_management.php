...
<head>
    ...
    <title>Autovermietung | Orte verwalten</title>
                            ...
                            foreach ($results as $result) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="location_management.php?del=<?php echo $result->id;?>" onclick="return confirm('Möchten Sie es wirklich löschen?');"><i class="text-danger fa fa-times"></i></a>
                                    </td>
                                </tr>
                                <?php $cnt = $cnt + 1;
                            }
