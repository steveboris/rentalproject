...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if(isset($_POST['submit'])) {
        ...
        if($lastInsertId) {
            $msg="Neue Marke erfolgreich gespeichert";
        } else {
            $error="Etwas ist schief gelaufen. Bitte versuchen Sie es nochnmal.";
        }
    }
?>
...
<head>
    ...
    <title>Autovermietung | Marke hinzufügen</title>
